					...
					<div id="dashboard_pro_connect" class="postbox">
						...
						<div class="inside">
							...
							<div class="featured-image alignright">
								...
								<img src="<?php echo GD_SYSTEM_PLUGIN_URL . 'gd-system-plugin/images/godaddy-pro-connect.svg' ?>">

							</div>

							<p><?php _e( 'Need a freelancer to design your website? GoDaddy Pro Connect filters through thousands of designers to put you in touch with the best ones for your site and budget.', 'gd_system' ) ?></p>

							<p><?php _e( 'We send you three on-budget quotes (no cost or obligation). You choose the best fit, and they get the job done.', 'gd_system' ) ?></p>

							<p class="submit">

								<a href="<?php echo esc_url( $pro_connect_url ) ?>" target="_blank" class="button button-primary"><?php _e( 'Learn More', 'gd_system' ) ?></a>

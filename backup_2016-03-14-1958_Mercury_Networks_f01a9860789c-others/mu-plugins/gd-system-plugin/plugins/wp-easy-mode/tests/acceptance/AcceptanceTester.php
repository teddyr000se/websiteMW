<?php //[STAMP] a497249abf6810f0d2d00f9dc651eafd
...
class AcceptanceTester extends \Codeception\Actor
{
     ...
     *
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Codeception\Module\AcceptanceHelper::seeSetting()
     */
    public function canSeeSetting($option_name, $option_value = null) {
        return $this->scenario->runStep(new \Codeception\Step\ConditionalAssertion('seeSetting', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
    ...
    public function seeSetting($option_name, $option_value = null) {
        return $this->scenario->runStep(new \Codeception\Step\Assertion('seeSetting', func_get_args()));
    }
     ...
     * @see \Codeception\Module\AcceptanceHelper::canSeePluginActive()
     */
    public function canSeePluginActive($plugin_basename) {
        return $this->scenario->runStep(new \Codeception\Step\Action('canSeePluginActive', func_get_args()));
    }
	 ...
	 *
	 * @param $plugin_basename
     * @see \Codeception\Module\AcceptanceHelper::canSeePluginInactive()
     */
    public function canSeePluginInactive($plugin_basename) {
        return $this->scenario->runStep(new \Codeception\Step\Action('canSeePluginInactive', func_get_args()));
    }
	 ...
	 * @param $page
	 * @param $shortcode
     * @see \Codeception\Module\AcceptanceHelper::canSeePageWithShortcode()
     */
    public function canSeePageWithShortcode($page, $shortcode) {
        return $this->scenario->runStep(new \Codeception\Step\Action('canSeePageWithShortcode', func_get_args()));
    }
}

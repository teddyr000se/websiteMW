...
final class WPEM_Customizer {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'wpem-customizer', WPEM_URL . 'assets/js/customizer.js', array( 'jquery', 'backbone', 'underscore' ), WPEM_VERSION, true );

		wp_enqueue_style( 'wpem-customizer', WPEM_URL . 'assets/css/customizer.css', array(), WPEM_VERSION );
